            ...
            <form onSubmit={handleRegisterStudent} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-surface-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all text-black placeholder:text-gray-400"
                  disabled={isLoading}
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="••••"
                  className="w-full px-4 py-3 bg-white border border-surface-border rounded-lg text-center tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all text-black placeholder:text-gray-400"
                  disabled={isLoading}
                  required
                />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 px-4 py-3 bg-white border border-surface-border rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-400 transition-all text-black placeholder:text-gray-400"
                    disabled={isLoading}
                  />
                </div>
              </div>
