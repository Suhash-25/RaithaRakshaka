...
const FAST_MARKET = {
  ...
  trend: 'rising',
  msp: 2380,
  best_market: 'APMC Bangalore',
  demand: 'High',
  ai_prediction: 'Showing instant cached mandi baseline while live data refreshes.',
  chart: [
    { label: '30 days ago', price: 2450 },
    { label: '2 weeks ago', price: 2580 },
    { label: '1 week ago', price: 2680 },
    { label: 'Today', price: 2800 },
    { label: 'Predicted', price: 2960 },
  ],
  top_markets: [
    { name: 'APMC Bangalore', price: 2850, distance_km: 35 },
    { name: 'Kolar APMC', price: 2760, distance_km: 70 },
    { name: 'Mysuru APMC', price: 2825, distance_km: 145 },
  ],
};
...
export default function MarketPage() {
  ...
  const [data, setData] = useState(FAST_MARKET);
  const [trending, setTrending] = useState([{ crop: 'Tomato', price: 2800, change: 4.5 }, { crop: 'Onion', price: 3500, change: 2.1 }, { crop: 'Rice', price: 4200, change: 1.4 }]);
  ...
  const load = async (crop) => {
    ...
    catch { setData((prev) => prev || FAST_MARKET); }
